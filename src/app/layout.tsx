...
import { NavbarLanding, NavbarLandingLink } from '@/components/sections/navbar-landing'
  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&family=Outfit:wght@100..900&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
            ...
            logo={
              <Link href="/" className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="50" height="50" viewBox="0 0 50 50">
                  ...
                  />
                  <path fill="#C9A96E" d="M.004 30.745h3.581V3.585h42.83v42.83h-6.464v3.581h10.05V0H.004v30.745Z" />
                </svg>
              </Link>
            }
            links={
              <>
                <NavbarLandingLink href="/#features">Features</NavbarLandingLink>
                <NavbarLandingLink href="/pricing">Pricing</NavbarLandingLink>
                <NavbarLandingLink href="/#examples">Examples</NavbarLandingLink>
                <NavbarLandingLink href="/blog">Blog</NavbarLandingLink>
              </>
            }
            cta={
              <Link
