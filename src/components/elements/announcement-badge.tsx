  ...
  return (
    <Link
      ...
      className={clsx(
        ...
        variant === 'normal' &&
          'bg-zinc-950/5 text-zinc-950 hover:bg-zinc-950/10 dark:bg-white/5 dark:text-white dark:inset-ring-1 dark:inset-ring-white/5 dark:hover:bg-white/10',
        variant === 'overlay' &&
          'bg-zinc-950/15 text-white hover:bg-zinc-950/20 dark:bg-zinc-950/20 dark:hover:bg-zinc-950/25',
        className,
      )}
    >
      ...
      <span
        className={clsx(
          ...
          variant === 'normal' && 'bg-zinc-950/20 dark:bg-white/10',
      ...
      <span
        className={clsx(
          ...
          variant === 'normal' && 'text-zinc-950 dark:text-yellow-500',
        )}
      >
