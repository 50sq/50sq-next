...
export function TestimonialTwoColumnWithLargePhoto({
  ...
  return (
    <section className={clsx('py-16', className)} {...props}>
      <Container>
        <figure className="grid grid-cols-1 gap-x-2 rounded-xl bg-mist-950/2.5 p-2 lg:grid-cols-2 dark:bg-white/5">
          <div className="flex flex-col items-start justify-between gap-10 p-6 text-mist-950 sm:p-10 dark:text-white">
