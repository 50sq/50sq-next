  ...
  return (
    <div id={id} {...props}>
      <button
        ...
        className="flex w-full items-start justify-between gap-6 py-4 text-left text-base/7 text-zinc-950 dark:text-white"
      >
        {question}
      ...
      <ElDisclosure
        id={`${id}-answer`}
        hidden
        className="-mt-2 flex flex-col gap-2 pr-12 pb-4 text-sm/7 text-zinc-700 dark:text-zinc-400"
      >
        {answer}
      </ElDisclosure>
    </div>
