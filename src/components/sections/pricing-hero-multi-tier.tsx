      ...
      <ElTabGroup>
        <Container className="flex flex-col gap-16">
          <div className="flex flex-col items-center gap-6">
            ...
            <ElTabList className="flex items-center gap-1 rounded-full bg-zinc-950/5 p-1 dark:bg-white/5">
              {options.map((option) => (
                <button
                  key={option}
                  type="button"
                  className="rounded-full px-4 py-1 text-sm/7 font-medium text-zinc-950 aria-selected:bg-zinc-950 aria-selected:text-white dark:text-white dark:aria-selected:bg-white/10 dark:aria-selected:text-white"
                >
                  {option}
                </button>
              ))}
