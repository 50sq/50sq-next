...
export function DetailedFeature({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-lg border border-zinc-800/50 bg-zinc-900/30 p-5">
      <div className="flex size-9 items-center justify-center rounded-lg border border-zinc-800 text-gold-400">
        {icon}
      </div>
