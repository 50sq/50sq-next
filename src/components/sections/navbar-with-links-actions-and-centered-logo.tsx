...
export function NavbarWithLinksActionsAndCenteredLogo({
  ...
  return (
    <header className={clsx('sticky top-0 z-10 bg-mist-100 dark:bg-zinc-950', className)} {...props}>
      ...
      <nav>
        ...
        <ElDialog className="lg:hidden">
          <dialog id="mobile-menu" className="backdrop:bg-transparent">
            <ElDialogPanel className="fixed inset-0 bg-mist-100 px-6 py-6 lg:px-10 dark:bg-zinc-950">
