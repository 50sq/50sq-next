...
export function HomeHero({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "relative mx-auto flex h-screen w-full max-w-full flex-col items-center justify-center overflow-hidden rounded-3xl",
        className,
      )}
    >
      ...
      <div className="relative z-20 flex flex-wrap items-center justify-center gap-4 pt-4">
        ...
        <Button variant="link">View Features</Button>
      </div>
